...
export const CHANGELOG = [
  {
    ...
    highlights: [
      ...
      "Exportar actividad a Excel para auditorias",
      "Nuevo tipo de documento Fotografia con miniatura en la lista de adjuntos",
      "Cierre automatico de sesion tras 5 minutos de inactividad",
      "Zoom de la interfaz bloqueado para evitar deformaciones accidentales",
    ],
  },
  {
    version: "1.8.0",
  ...
  },
  {
    ...
    highlights: [
      "Boton Importar Excel en el modulo de Turbinas (con plantilla descargable)",
      "Boton PDF en Turbinas: exporta listado completo con numero de serie, GG, PT, rodamientos y estado",
      "Numero de serie incluido en exportacion PDF de motores (lista y ficha de detalle)",
    ],
  },
  {
    version: "1.4.5",
